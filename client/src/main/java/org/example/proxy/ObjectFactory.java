...
public class ObjectFactory {
    ...
    private static final QName _ConversionEuroToDirham_QNAME = new QName("http://ws.example.org/", "ConversionEuroToDirham");
    private static final QName _ConversionEuroToDirhamResponse_QNAME = new QName("http://ws.example.org/", "ConversionEuroToDirhamResponse");
    ...
    private static final QName _ListeComptes_QNAME = new QName("http://ws.example.org/", "listeComptes");
    private static final QName _ListeComptesResponse_QNAME = new QName("http://ws.example.org/", "listeComptesResponse");
     ...
     */
    @XmlElementDecl(namespace = "http://ws.example.org/", name = "ConversionEuroToDirham")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.example.org/", name = "ConversionEuroToDirhamResponse")
